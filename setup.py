...
setuptools.setup(
    ...
    install_requires = ['numpy>=1.17', 'h5py', 'pytorch>=1.10', 'torchvision>=0.10', 'lightning', 'tensorboard', 'transformers', 'timm', 'scikit-learn', 'scikit-image', 'rasterio', 'pyproj', 'geopandas'],
    python_requires = ">=3.8",
